...
export const RHYME_SPRITES = Object.fromEntries(['sun','bun','cake','snake','bear','pear','moon','spoon','tree','bee','house','mouse','hat','bat','sock','rock','clock','box','whale','snail','jar','coat','boat','goat'].map(k => [k, 1]));`;
      },
    },
  ],
  test: {
