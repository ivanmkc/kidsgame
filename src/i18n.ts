...
const EN: Table = {
  ...
  'card.highlow.blurb': 'Was the second note higher or lower?',
  ...
  'shell.highlow.sub': 'Was the second note higher or lower?',
...
const JA: Table = {
  ...
  'card.highlow.blurb': 'にばんめの おとは たかい？ ひくい？',
  ...
  'shell.highlow.sub': 'にばんめの おとは たかい？ ひくい？',
