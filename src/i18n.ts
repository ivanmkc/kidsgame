...
const JA: Table = {
  ...
  'card.rules.blurb': 'ルールにあうものを タップ！',
...
const CMN: Table = {
  ...
  'shell.letters.title': '找字母',
  'shell.letters.titleKana': '找假名',
  'shell.letters.subTap': '听到字母就点它',
  'shell.letters.subSound': '哪个字母发这个音？',
...
const YUE: Table = {
  ...
  'card.rules.blurb': '跟住規則撳啱嘅圖！',
  'card.sticker.title': '貼紙派對',
  'card.sticker.blurb': '用貼紙裝飾幅畫！',
  'card.story.title': '故事之路',
  'card.story.blurb': '揀故事下一步！',
  'card.letters.title': '搵字母',
  'card.letters.blurb': '聽到字母，快啲撳佢！',
  'card.sounds.title': '首音',
  ...
  'shell.letters.title': '搵字母',
  'shell.letters.titleKana': '搵假名',
  'shell.letters.subTap': '聽到字母就撳佢',
  'shell.letters.subSound': '邊個字母發呢個音？',
