...
export const DRESSUP_DESCRIPTIONS: Record<string, string> = {
  ...
  kimono: 'a silky kimono with a cherry-blossom pattern',
  raincoat: 'a bright yellow raincoat with a hood',
  party_hat: 'a pointy party hat with polka dots',
  police_cap: 'a smart blue police officer cap',
  fire_helmet: 'a shiny red firefighter helmet',
  chef_hat: 'a tall puffy white chef hat',
  cowboy_hat: 'a brown cowboy hat with a wide brim',
  space_helmet: 'a round glass astronaut space helmet',
  flower_crown: 'a crown woven from colorful flowers',
  scarf: 'a cozy striped winter scarf',
  ballet_slippers: 'soft pink ballet slippers with ribbons',
  rain_boots: 'splashy red rubber rain boots',
