...
export const WORDS: WordEntry[] = [
  { icon: 'dog', en: 'dog', letter: 'D', sound: 'duh', rhymeKey: 'og', cmnRhyme: 'ou', yueRhyme: 'au', ja: 'いぬ', jaR: 'inu', cmn: '狗', cmnR: 'gǒu', yue: '狗', yueR: 'gau' },
  ...
  { icon: 'rabbit', en: 'rabbit', letter: 'R', sound: 'rrr', cmnRhyme: 'i', yueRhyme: 'ai', ja: 'うさぎ', jaR: 'usagi', cmn: '兔子', cmnR: 'tùzi', yue: '兔仔', yueR: 'tou-zai' },
  ...
  { icon: 'blossom', en: 'flower', letter: 'F', sound: 'fff', jaRhyme: 'na', cmnRhyme: 'a', yueRhyme: 'aa', ja: 'はな', jaR: 'hana', cmn: '花', cmnR: 'huā', yue: '花', yueR: 'faa' },
  { icon: 'sunflower', en: 'sunflower', letter: 'S', sound: 'sss', cmnRhyme: 'ei', yueRhyme: 'ai', ja: 'ひまわり', jaR: 'himawari', cmn: '向日葵', cmnR: 'xiàngrìkuí', yue: '向日葵', yueR: 'hoeng-jat-kwai' },
  ...
  { icon: 'strawberry', en: 'strawberry', letter: 'S', sound: 'sss', jaRhyme: 'go', cmnRhyme: 'ei', yueRhyme: 'ei', ja: 'いちご', jaR: 'ichigo', cmn: '草莓', cmnR: 'cǎoméi', yue: '士多啤梨', yueR: 'si-do-be-lei' },
  ...
  { icon: 'rocket', en: 'rocket', letter: 'R', sound: 'rrr', jaRhyme: 'to', ja: 'ロケット', jaR: 'roketto', cmn: '火箭', cmnR: 'huǒjiàn', yue: '火箭', yueR: 'fo-zin' },
  { icon: 'soccer', en: 'ball', letter: 'B', sound: 'buh', jaRhyme: 'ru', cmnRhyme: 'iu', yueRhyme: 'au', ja: 'ボール', jaR: 'booru', cmn: '足球', cmnR: 'zúqiú', yue: '足球', yueR: 'zuk-kau' },
  ...
  { icon: 'gift', en: 'present', letter: 'P', sound: 'puh', jaRhyme: 'to', cmnRhyme: 'u', ja: 'プレゼント', jaR: 'purezento', cmn: '礼物', cmnR: 'lǐwù', yue: '禮物', yueR: 'lai-mat' },
];
